...
function playerInformation() {
    ...
    $("#card").css('border', "solid 4px blue"); 
    NBAPlayerGif(player);
...
function NBAPlayerGif(player) {
    ...
    $.ajax({
        ...
        $("#card-landscape").append("<img src=" + gifs.data[0].images.original.url + ">");
...
function NBAPlayerInfo(player) {
    ...
    $.ajax({
        ...
        $("#playerName").css({'font-family': "Impact,Charcoal,sans-serif", 'font-size': "xxx-large", 'text-align': 'center'});
